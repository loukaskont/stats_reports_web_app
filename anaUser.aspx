<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="anaUser.aspx.cs" Inherits="statistika_net4.statistika.anaUser" MasterPageFile="~/Site.Master" %>
...
<script type="text/javascript">
    ...
    $('form').live("submit", function () {
        ...
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="CSV" Width="63px" />
        ...
        <asp:GridView ID="GridViewGeotemaxia1" runat="server" Height="155px" Width="342px">
        </asp:GridView>
    
        <br />
        <br />
        <asp:Label ID="Label3" runat="server"></asp:Label>
        <asp:GridView ID="GridViewDikaiomata" runat="server" Height="155px" Width="342px">
        </asp:GridView>
        <br />
    <br />
    <br />
